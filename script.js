  ...
  fetch(
    ...
    .then(myJson => {
      ...
      myJson.forEach(obj => {
        ...
        // clone.querySelector("[data-field='image']").src = obj.acf.billede.url;
        // clone.querySelector("[data-field='link']").href = obj.acf.link;
        clone
          .querySelector("[data-field='title']")
          .addEventListener("click", () => {
            window.location.href = "single.html?title=" + obj.acf.title;
          });
        // clone.querySelector("[data-field='langbeskrivelse']").textContent =
        //   obj.acf.langbeskrivelse;
        clone.querySelector("[data-field='kortbeskrivelse']").textContent =
          obj.acf.kortbeskrivelse;
...
function VisInfo() {
  ...
  // document.querySelector("#overskrift").addEventListener("mousemove", e => {
  //   console.log(e);
  //   if (e.composed) {
...
function gemInfo1() {
  document
    .querySelector("#emne-1 #info-box", "nummer1")
